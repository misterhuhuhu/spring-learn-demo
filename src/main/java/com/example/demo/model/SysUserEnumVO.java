...
public class SysUserEnumVO {
    ...
    * 状态（-1-删除，0-禁用，1-启用）
    */
    private ExampleTypeHandler.SysUserStatus status;
    ...
    */
    ...
    public SysUserEnumVO setSysUserRoleVOList(final List<SysUserRoleVO> sysUserRoleVOList) {
    ...
    public ExampleTypeHandler.SysUserStatus getStatus() {
        return status;
    }
    
    public SysUserEnumVO setStatus(final ExampleTypeHandler.SysUserStatus status) {
        this.status = status;
        return this;
    }
